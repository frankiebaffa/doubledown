...
" Tag Elements
syn region ddownOpenTag  contained containedin=ddownLayout oneline contains=ddownId,ddownClass,ddownTagName,ddownAttrList start="_\(CONTENT\|LAYOUT\)\@!" end="\(CONTENT\|LAYOUT\)\@<!|"
syn region ddownCloseTag contained containedin=ddownLayout oneline contains=ddownTagName                               start="|\(CONTENT\|LAYOUT\)\@!" end="\(CONTENT\|LAYOUT\)\@<!_"
...
"hi def link ddownProcTag      Comment
